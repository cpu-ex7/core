...
module design_1_top_wrapper_0_0(clk, sw_n, sw_e, sw_s, sw_w, led, txd, fpu_data_a, 
  fpu_data_b, fpu_data_c, fpu_out, fpu_in_valid, fpu_out_valid, o_addr, d_addr, odata, rdata, wdata, 
  wea, rxd)
/* synthesis syn_black_box black_box_pad_pin="clk,sw_n,sw_e,sw_s,sw_w,led[7:0],txd,fpu_data_a[31:0],fpu_data_b[31:0],fpu_data_c[7:0],fpu_out[31:0],fpu_in_valid[9:0],fpu_out_valid,o_addr[9:0],d_addr[9:0],odata[31:0],rdata[31:0],wdata[31:0],wea,rxd" */;
  input clk;
  input sw_n;
  input sw_e;
  input sw_s;
