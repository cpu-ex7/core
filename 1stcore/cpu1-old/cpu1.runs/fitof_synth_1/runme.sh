...
HD_PWD='/home/tansei/Desktop/cpu/2017/1stcore/cpu1/cpu1.runs/fitof_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fitof.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fitof.tcl
