...
HD_PWD='/home/tansei/Desktop/cpu/2017/1stcore/cpu1/cpu1.runs/fftoi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fftoi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fftoi.tcl
