...
HD_PWD='/home/tansei/Desktop/cpu/2017/1stcore/cpu2-sim/cpu2.runs/design_1_fpu_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_fpu_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_fpu_wrapper_0_0.tcl
