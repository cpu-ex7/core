...
HD_PWD='/home/tansei/cpu1/cpu1.runs/design_2_top_wrapper_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_top_wrapper_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_top_wrapper_0_1.tcl
