...
HD_PWD='/home/tansei/Desktop/cpu/2017/1stcore/cpu_sim/cpu_sim.runs/fsqrt_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsqrt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsqrt.tcl
